<template>
  <div class="gearArea" v-show="show">
    <transition name="fade">
      <div class="area_ctrl" v-if="isOpened > 0" v-show="show">
        <div class="area_btn_box">
          <div class="area_btn larea_cancel" @click="close">
            {{ cancelText }}
          </div>
          <div class="area_btn larea_finish" @click="finish">
            {{ confirmText }}
          </div>
        </div>
        <div class="area_roll_mask">
          <div class="area_roll">
            <div>
              ...
              >
                <div class="tooth" v-for="(item, index) in pData1" :key="index">
                  {{ item.text }}
                </div>
              </div>
